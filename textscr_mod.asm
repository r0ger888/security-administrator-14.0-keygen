...
.data
ScrollFont		LOGFONT <0FFFFFFF4h,0,0,0,2BCh,0,0,0,0,4,0,4,0,'Times New Roman'>
ScrollText	    		db	"KeyGen for Security Administrator 14.0                                                                 "
						...
						db  "ies ! :3)                                                           "
						db  "                                  if you like the program , just buy it !",0
...
ScrollerInit proc hWnd:HWND
	...
	m2m scr.scroll_hwnd,hWnd
		...
		mov scr.scroll_x,9
		mov scr.scroll_y,220
		
		mov scr.scroll_width,305
