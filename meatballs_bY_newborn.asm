...
.data
AboutTitle		db "greetz & sh0ut0utz ..",0

lpString        dd offset AboutText

AboutText 		db "PERYFERiAH tEAM Proudly Present",0
				db "Security Administrator 14.0",13
				db "KeyGen by GRUiA [PRF]",0
				db "Protection : Serial",13
				db "Date : 19.11.2021",13
				db "Music : [hostlov] by Mrgamer",0
				db "Shoutoutz 2:",0
				db "Mrgamer 4 music",13,"newborn for meatballz effect",13,"r0ger for GFX",0
...
AboutFont       LOGFONT  <16,0,0,0,FW_EXTRABOLD,0,0,0,DEFAULT_CHARSET,OUT_DEFAULT_PRECIS,CLIP_DEFAULT_PRECIS,DEFAULT_QUALITY, 0,"courier">
...
AboutProc proc xWnd:DWORD, uMsgz:DWORD, wParamz:DWORD, lParamz:DWORD
...
LOCAL hColor:DWORD
                ...
                invoke  SetWindowText,[xWnd],addr AboutTitle
...
loc_402295:                             
                ...
                invoke ShowWindow,aWnd,SW_SHOW
...
loc_4026D5:                             ; CODE XREF: timerProc+92?j
                ...
                mov     eax, [edi]
                and     eax, 1;0000A6FFh ; meatball border color 1 (original - 0FF0000h) [ r0ger ]
                add     eax, 1;0000A6FFh ; meatball border color 2 (original - 0FF0000h) [ r0ger ]
                shr     eax, 1
                mov     [edi], eax
